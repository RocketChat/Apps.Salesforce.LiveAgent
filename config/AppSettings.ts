...
export const AppSettings: Array<ISetting> = [
	...
	},
	{
		...
		packageValue: false,
		i18nLabel: 'Enable Dialogflow End Chat Event (Optional)',
		i18nDescription: 'Enabling this setting will automatically trigger an end chat event on Dialogflow side. Requires additional configuration.',
		required: false,
	},
	{
		id: AppSettingId.DIALOGFLOW_END_EVENT_NAME,
		public: true,
		type: SettingType.STRING,
		packageValue: 'end_live_chat',
		i18nLabel: 'Dialogflow End Chat Event Name (Optional)',
		i18nDescription: 'Enter the Dialogflow event name you want app to trigger as soon as the chat is ended with agent.',
		required: false,
	},
	{
