...
export const AppSettings: Array<ISetting> = [
  {
	...
	i18nDescription:
		'Enter Omnichannel agent username, hadling requests from Dialogflow Bot.',
	required: true,
  },
  {
	...
	i18nDescription:
		'Enter Omnichannel agent username we will be using as Salesforce Live Agent.',
	required: true,
  },
  {
	...
	i18nDescription:
		'Enter Omnichannel agent password we will be using as Salesforce Live Agent.',
	required: true,
  },
  {
  ...
  },
  {
	...
	i18nDescription:
		'Enter Omnichannel department name containing Salesforce agent user.',
	required: true,
  },
  {
